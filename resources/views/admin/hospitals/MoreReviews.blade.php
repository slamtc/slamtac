...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('admin/hospitals/'.$hospital->id) }}">{{ $hospital->hospital_name_ar}}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <span>التعليقات</span>
    ...
    <div class="col-md-12">
              <div class="row">
                            <div class="col-lg-12 col-xs-12 col-sm-12">
                                    ...
                                    <div class="portlet-body">
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="portlet_comments_1">
                                                ...
                                                @if($hospitals_reviews)
                                                @foreach($hospitals_reviews as $reviews)
                                ...
                                <?php echo $hospitals_reviews->render(); ?>
                            </div>
